...
while True:
    ...
    main_font.render('roty: ' + str(round(math.degrees(rot_y), 2)), screen, (4, 270))
    ...
    #print('position: ' + str(position), screen, (4, 390))
    ...
    main_font.render('rotx: ' + str(round(math.degrees(rot_x), 2)), screen, (4, 290))
    ...
    #print(enumerate([-rot_x, -rot_y, rot_z]))
    #print("\n\n\n\n\n")
